...
export type CommentDocsAccountConfig = z.infer<typeof commentDocsAccountSchema>;

export const CommentDocsChannelConfigSchema = buildChannelConfigSchema(
  commentDocsAccountSchema,
  { uiHints: {} },
);
