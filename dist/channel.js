...
import { resolveCommentDocsAccount, } from "./src/accounts.js";
...
const loadCommentDocsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime.js"), "commentDocsChannelRuntime");
const resolveCommentDocsDmPolicy = createScopedDmSecurityResolver({
...
export const commentDocsPlugin = createChatChannelPlugin({
    base: {
        id: "comment-io",
        ...
        status: createComputedAccountStatusAdapter({
            ...
            probeAccount: async ({ account }) => {
                ...
                const result = await runtime.verifyCommentDocsAgent(account.baseUrl, account.config.agentSecret);
